      ...
      <PopoverContent className="w-[200px] p-0">
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-4">
          ...
          <button
            ...
            className="w-full sm:w-auto px-8 py-3.5 bg-linear-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black font-semibold rounded-xl shadow-lg shadow-yellow-500/30 transition-all transform hover:scale-105 flex items-center justify-center gap-2"
          >
            <Save size={18} />
            Upload Music
          </button>
