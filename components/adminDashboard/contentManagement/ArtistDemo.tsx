            ...
            <div className="w-full mx-auto">
                ...
                <div className="space-y-0">
                    ...
                    {submissions.map((submission, index) => (
                        <div
                            key={submission.id}
                            className={`flex items-center justify-between py-6 px-4 hover:bg-zinc-900/50 transition-colors ${index !== submissions.length - 1 ? "border-b border-zinc-800" : ""
                                }`}
                        >
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                {submission.status === "APPROVED" ? (
                                    ...
                                    <span className="px-3 py-1 text-xs font-semibold text-red-500 bg-red-500/10 border border-red-500/20 rounded">
                                        REJECTED
                                    </span>
                                ) : (
