...
export const adminApi = baseApi.injectEndpoints({
    endpoints: (builder) => ({
        ...
        // TOGGLE SAVED
        toggleSavedMusic: builder.mutation<any, string>({
            query: (id) => ({
                url: `${API_ENDPOINTS.SAVED.TOGGLE_SAVED_MUSIC}/${id}`,
                method: "POST",
            }),
            invalidatesTags: ["SavedMusic", "Music"],
        }),
        // GET SAVED MUSIC
        getSavedMusic: builder.query<
            GetSavedMusicResponseTypes,
            Record<string, string | number>
        >({
            query: (params) => ({
                url: API_ENDPOINTS.SAVED.TOGGLE_SAVED_MUSIC,
                method: "GET",
                params,
            }),
            providesTags: ["SavedMusic"],
        }),
    }),
...
export const {
    ...
    useToggleSavedMusicMutation,
    useGetSavedMusicQuery,
} = adminApi;
