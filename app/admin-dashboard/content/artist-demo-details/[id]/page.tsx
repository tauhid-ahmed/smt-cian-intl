    ...
    <div className="min-h-screen bg-linear-to-br from-zinc-950 via-black to-zinc-950 text-white p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        <div className="bg-linear-to-b from-zinc-900 to-zinc-950 rounded-3xl p-8 md:p-10 shadow-2xl border border-zinc-800">
          {/* Header Section */}
          <div className="mb-8 pb-8 border-b border-zinc-800 flex  justify-between">
            ...
            <div>
              <button
                ...
                // onClick={() => router.back()}
                className="mb-6 flex items-center gap-2 text-gray-400 hover:text-white transition group border rounded-xl p-1"
              >
                <div className="p-2 rounded-full bg-zinc-900 group-hover:bg-zinc-800 transition ">
                  <ArrowLeft />
                </div>
