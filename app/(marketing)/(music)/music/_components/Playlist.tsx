...
const MusicPlaylist = () => {
  ...
  const WaveformSpectrum: React.FC<WaveformSpectrumProps> = ({
    ...
    return (
      <div className="flex flex-wrap items-center h-12 w-full gap-px">
        ...
        <div className="max-w-full mx-auto px-6 py-6">
          ...
          <div className="space-y-0">
            {tracks.map((track) => (
              <div
                key={track.id}
                className="group relative flex flex-wrap items-center gap-4 py-2 hover:bg-white/5 transition-colors"
              >
                ...
                {/* Duration */}
                <div className="text-white/50 text-xs tabular-nums w-12 shrink-0">
                  {track.duration}
                </div>
